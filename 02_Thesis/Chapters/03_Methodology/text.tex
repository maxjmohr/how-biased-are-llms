...
\begin{table}[h!]
    ...
    Large values & Base scenario but multiplication of the study variables (e.g. prices) times 55555.5 \\ \bottomrule
    \end{tabular}
...
\par First give an overview of the detected biases, maybe a grid with biases on y and models on x, and a distribution, comparing detected biases and modified detected biases
